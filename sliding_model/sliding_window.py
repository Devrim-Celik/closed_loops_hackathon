...
def check_fittest(w, n, optimal_I, df, dt, slide_step, candidate_init_states, iter):
...
def generate_windows(df, vel, fn, w_length=2.5, slide_step=1, dt=0.005, K=3, I_levels=9):
    ...
    for w in range(0, N - 2 * k, slide_step):
        ...
        job = partial(check_fittest, w, n, optimal_I, df, dt, slide_step, candidate_init_states)
